...
const IMPORT_PLUGIN = ROOT + '/plugins/gsvg.shapes.script.js';
const URL           = '/test/lib/plugins/shapes/cases/';
const FOLDER        = './test/lib/plugins/shapes/cases/';
...
const results = {
  ...
  case04 : `<svg viewBox="0 0 200 500" width="200" height="200"><path fill="none" stroke-width="10" stroke="black" d="M100,150A100,100,0,0,0,0.38053019082543926,241.28442572523414"></path><path fill="none" stroke-width="10" stroke="black" d="M200,250A100,100,0,0,0,108.71557427476581,150.38053019082543"></path><path fill="none" stroke-width="10" stroke="black" d="M100,350A100,100,0,0,0,199.61946980917457,258.7155742747658"></path><path fill="none" stroke-width="10" stroke="black" d="M0,250A100,100,0,0,0,91.28442572523417,349.6194698091746"></path></svg>`,
