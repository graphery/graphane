...
const IMPORT_PLUGIN = ROOT + '/plugins/gsvg.observe.style.script.js';
const URL           = '/test/svg/plugins/observe.style/cases/';
const FOLDER        = './test/svg/plugins/observe.style/cases/';
