...
const IMPORT_PLUGIN = ROOT + '/plugins/gsvg.observe.resize.script.js';
const URL           = '/test/svg/plugins/observe.resize/cases/';
const FOLDER        = './test/svg/plugins/observe.resize/cases/';
