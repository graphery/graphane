...
const results = {
  ...
  case03 : `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" id="svg" style="width: 100px; height: 100px"> <circle cx="25" cy="50" r="20" fill="violet" style="visibility: inherit;"/> <circle cx="75" cy="50" r="20" fill="orange" style="visibility: hidden;"/> </svg>`,
  ...
  case08 : `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0,0,100,100" width="100" height="100"> <line x1="10" y1="10" x2="90" y2="90" stroke="black" stroke-width="10"/> </svg>`,
}
