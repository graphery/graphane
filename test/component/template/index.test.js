...
const ROOT   = '/';
const IMPORT = ROOT + 'src/component/template.js';
const URL    = ROOT + 'test/component/template/cases/';
const FOLDER = './test/component/template/cases/';
...
for await (const dirent of dir) {
  ...
  test.describe(name, () => {
    ...
    if (['case04', 'case05'].includes(code)) {
    ...
    if ('case07' === code) {
      test('compare message', async ({page}) => {
        ...
        await expect(result).toHaveText('Not Found (404): http://localhost:7200/src/g-template/test/assets/unknown.svg')
      });
    }
